        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="text-sm text-slate-500">
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2"><Cpu className="h-4 w-4 text-rose-500" /> 1D-CNN + INT8 + Pruning</li>
              <li className="flex items-center gap-2"><ShieldCheck className="h-4 w-4 text-emerald-500" /> AAMI EC57 compliant metrics</li>
              <li className="flex items-center gap-2"><Database className="h-4 w-4 text-rose-500" /> MIT-BIH · PTB-XL · EU ST-T</li>
            </ul>
          </div>
          <div className="text-sm text-slate-500">
